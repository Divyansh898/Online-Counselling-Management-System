<%-- 
    Document   : footer
    Created on : Jul 31, 2019, 7:01:42 AM
...
<html>
    ...
    <div class="row" >
        <div class="col-sm-2"><span style="color:#fcf4b6; font-size: 25px; font-family:'monotype corsiva';margin-left: 50px;"><br>Quick Link<br><a href="#" style="color:#fcf4b6;text-decoration-line: none">Home</a><br><a href="#" style="color:#fcf4b6;text-decoration-line: none">Registration Detail</a><br><a href="#" style="color:#fcf4b6;text-decoration-line: none">Print form</a><br><a href="#" style="color:#fcf4b6;text-decoration-line: none">Feedback</a><br><a href="#" style="color:#fcf4b6;text-decoration-line: none">Setting</a><br></span></div>
