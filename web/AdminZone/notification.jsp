...
<div class="row" style="min-height: 100px;"></div>
                    <div class="row" style="min-height: 100px;">
                        ...
                        <div class="col-sm-4">
                            <form action="../codes/notification.jsp" method="POST">
                                <textarea  id="msg" name="msg" rows="4" class="form-control md-textarea"  >Type here...</textarea>
                       <input type="submit" value="Add Notification" class="btn btn-default" style="background:#fcf4b6;margin-top: 20px;margin-left: 30%;color:#181f6d;font-size: 15px; font-family: monospace;font-weight: bold; "/>
                        </form>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
