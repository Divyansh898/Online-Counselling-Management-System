...
#myMenu li a:hover {
  background-color: #eee;
    ...
    <li><a href="Logout.html" class="btn btn-primary" style="background: #fedbb4;border:1px solid #dc7503; color:#dc7503;font-size:20px;font-weight: bold;">Logout</a></li>
                ...
                <div class="col-sm-9 "  style="background:teal;;min-height: 800px;">
                     <br>
                    <br>
                    <br>
                    <br><br>
                    <div class="row">
                       ...
                       <div class="col-sm-4">
    <form action="../UserZone/downloadadmitcard.jsp" method="post">
           
            <input type="text" name="rollno" class="form-control" autocomplete="off" required="" placeholder="Enter Roll no.."/>
            <br><br>
            <input type="submit" class="btn btn-success" value="Click Here" style="margin-left:40%;"/>
        </form>
