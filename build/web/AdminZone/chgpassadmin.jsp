 ...
 background:brown;
    ...
    <li><a href="Logout.html" class="btn btn-danger" style="color:white;font-size:20px;font-weight: bold;">Logout</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-5" style="background:#fefbe0">
                    <div class="row" style="min-height:100px;"> <span style="color:#d9534f;font-size:30px;font-family: 'monotype corsiva';font-weight: bold;margin-left:30%"> Change Password</span></div>
                    <form class="form-horizontal" action="../codes/changepasswrd.jsp">
  <div class="form-group">
    <label class="control-label col-sm-3" for="oldpwd" style="color:#d9534f">Old Password </label>
    <div class="col-sm-9">
      <input type="password" class="form-control" id="oldpwd" name="oldpwd" placeholder="Enter Old password">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-3" for="newpwd" style="color:#d9534f;">New Password</label>
    <div class="col-sm-9"> 
      <input type="password" class="form-control" id="newpwd"  name="newpwd" placeholder="Enter New password">
    </div>
  </div>
                          <div class="form-group">
    <label class="control-label col-sm-3" for="confirmpwd" style="color:#d9534f;"> Confirm Password</label>
    <div class="col-sm-9"> 
  ...
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        <label style="color:#d9534f;"><input type="checkbox"> Remember me</label>
      </div>
    </div>
  </div>
  <div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" class="btn btn-default" style="background: #d9534f;color:white;">Submit</button>
    </div>
  </div>
</form>
