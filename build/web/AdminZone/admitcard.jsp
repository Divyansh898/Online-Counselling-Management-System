...
<div class="row" style="min-height: 30px;"></div>
                    <div class="row" style="min-height: 100px;">
                        ...
                        <div class="col-sm-4">
                            <form action="../uploadadmitcard" method="POST" enctype="multipart/form-data">
                            <span style="color:#fcf4b6;font-size: 20px; font-family: monospace;font-weight: bold;">   Name</span><br>
                            <input type="text" name="name" class="form-control" id="name" placeholder="Enter name" required=""/><br>
                                                 <span style="color:#fcf4b6;font-size: 20px; font-family: monospace;font-weight: bold;"> Father Name</span><br>
                            <input type="text" name="Fname" class="form-control" id="Fname" placeholder="Enter Father name" required=""/><br>
                            <span style="color:#fcf4b6;font-size: 20px; font-family: monospace;font-weight: bold;">   Roll no.</span><br>
                       <input type="text" name="rollno" class="form-control" id="rollno" placeholder="Enter Rollno" required="" /><br>
                        ...
                        <span style="color:#fcf4b6;font-size: 20px; font-family: monospace;font-weight: bold;"> Ranking</span><br>
                        <input type="text" name="ranking" class="form-control" id="ranking" placeholder="Enter ranking" required=""/><br>
<span style="color:#fcf4b6;font-size: 20px; font-family: monospace;font-weight: bold;"> Upload</span><br>
                        <input type="file" name="file" class="form-control" id="file" placeholder="Enter file" /><br>
                       <input type="submit" value="Generate Admit card" class="btn btn-default" style="background:#fcf4b6;margin-left: 25%;color:#181f6d;font-size: 15px; font-family: monospace;font-weight: bold; "/>
                        </form>
                        </div>
                        <div class="col-sm-4"></div>
                    </div>
