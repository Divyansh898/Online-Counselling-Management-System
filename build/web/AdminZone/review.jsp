<%-- 
    Document   : review
    Created on : Aug 8, 2019, 4:03:38 PM
 ...
 background:brown;
    ...
    <li><a href="Logout.html" class="btn btn-danger" style="color:white;font-size:20px;font-weight: bold;">Logout</a></li>
                ...
                <div class="col-sm-9"  style="background: #181f6d;min-height: 660px;">
                    <div class="row" style="min-height:100px;"><span style="color:#fcf4b6;font-family: monospace;font-size: 35px;margin-left: 40%"> Review Details</span></div>
                     <div class="row" style="min-height:100px;">
                         <div class="col-sm-3"></div>
                          <div class="col-sm-6">
                    <table  style="color:white;width:100%;border: 3px solid #fcf4b6;">
            <tr>
                <th style="border:3px solid #fcf4b6;text-align: center;color:#fcf4b6;font-family: monospace;font-size: 20px;">Name</th>
                 <th style="border:3px solid #fcf4b6;text-align: center;color:#fcf4b6;font-family: monospace;font-size: 20px;">Mobile No.</th>
                  <th style="border:3px solid #fcf4b6;text-align: center;color:#fcf4b6;font-family: monospace;font-size: 20px;">Rating Star</th>
            </tr>
            <%
