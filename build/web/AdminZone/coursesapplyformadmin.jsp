<%-- 
    Document   : coursesapplyformadmin
    Created on : Aug 10, 2019, 12:47:54 AM
 ...
 background:brown;
    ...
    <li><a href="Logout.html" class="btn btn-danger" style="color:white;font-size:20px;font-weight: bold;">Logout</a></li>
                ...
                <div class="col-sm-9"  style="background: #181f6d;min-height: 660px;">
                    <div class="row" style="min-height:100px;"><span style="color:#fcf4b6;font-family: monospace;font-weight: bold;font-size: 35px;margin-left: 30%;margin-top: 30px;">Courses Form Details </span></div>
                    <div class="row">
                        <div class="col-sm-2"></div>
                        <div class="col-sm-8">
                    <table border="1" style="color:#fcf4b6;font-family: monospace;font-size: 15px;text-align: center;width:100%;">
                        <tr>
                            <th style="border:3px solid #fcf4b6;text-align: center; ">Name</th>
                            <th style="border:3px solid #fcf4b6;text-align: center; ">Father Name</th>
                            <th style="border:3px solid #fcf4b6;text-align: center; ">Mobile Number</th>
                            <th style="border:3px solid #fcf4b6;text-align: center; ">Email</th>
                            <th style="border:3px solid #fcf4b6 ;text-align: center;">Qualification</th>
                            <th style="border:3px solid #fcf4b6;text-align: center; ">Address</th>
                            <th style="border:3px solid #fcf4b6;text-align: center; ">Gender</th>
             ...
             <tr>
                 ...
                 <td style="border:3px solid #fcf4b6 "><%=rs.getString(6)%></td>
                 <td style="border:3px solid #fcf4b6 "><%=rs.getString(7)%></td>
